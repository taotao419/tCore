...
impl Processor {
    ...
    pub fn task_current(&mut self)->Option<Vec<TaskControlBlock>>{
...
pub fn take_current_task()->Option<Arc<TaskControlBlock>>{
    return PROCESSOR.exclusive_access().task_current();
}
///Get running task
...
pub fn current_trap_cx() ->&'static mut TrapContext{
    return current_task().unwrap().inner_exclusive_access().get_trap_cx();
}
